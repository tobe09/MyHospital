<%@ Page Title="Register SuperUsers Administrators" Language="C#" MasterPageFile="~/HospitalMaster2.Master" AutoEventWireup="true" CodeBehind="RegAdminSup.aspx.cs" Inherits="HospitalManager.RegAdminSup" %>

<asp:Content ID="Content1" ContentPlaceHolderID="SideContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2 style="text-align: center;">Registration/Update Information for Superusers and Administrators</h2>
    <table>
        <tr>
            <td colspan="3">
        ...
        <tr>
            <td style="font-size: 20px;"><b>Role</b></td>
            <td>
                <asp:DropDownList ID="RoleList" runat="server" AutoPostBack="true" CssClass="TextBox" OnSelectedIndexChanged="RoleList_SelectedIndexChanged">
        ...
        <tr>
            ...
            <td style="width: 50px">
                <asp:RegularExpressionValidator ID="RegularExpressionValidator15" runat="server" Display="Dynamic" CssClass="error" Text="*" ErrorMessage="Wrong user Id syntax" ControlToValidate="UserIdBox" ValidationExpression="^(([S|s][U|u][P|p])|([A|a][D|d][M|m]))[0-9][0-9][0-9]$"></asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
            <td style="width: 300px">
        ...
        <tr>
            <td>Password</td>
            <td>
                <asp:TextBox CssClass="TextBox" ID="PasswordBox" runat="server" Width="200px" TextMode="Password"></asp:TextBox></td>
            <td style="width: 50px">
                <asp:RegularExpressionValidator ID="RegularExpressionValidator14" runat="server" ControlToValidate="PasswordBox" CssClass="error" Display="Dynamic" ErrorMessage="Password must be between 4 and 32 characters" Text="*" ValidationExpression="^[\w\W]{4,32}$"></asp:RegularExpressionValidator>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ControlToValidate="PasswordBox" CssClass="error" Display="Dynamic" ErrorMessage="Password cannot be empty" Text="*"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>Confirm Password</td>
            <td>
                <asp:TextBox CssClass="TextBox" ID="ConfirmPasswordBox" runat="server" Width="200px" TextMode="Password"></asp:TextBox></td>
            <td style="width: 50px;">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ControlToValidate="ConfirmPasswordBox" CssClass="error" Display="Dynamic" ErrorMessage="Confirm your password" Text="*"></asp:RequiredFieldValidator>
        ...
        <tr>
            ...
            <td style="width: 50px">
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="DobBox" CssClass="error" Display="Dynamic" ErrorMessage="Enter a valid date of birth (Format: 25/12/2017 or 25-12-2017)" Text="*" ValidationExpression="^(?:0[1-9]|[12]\d|3[01])([\/.-])(?:0[1-9]|1[012])\1(?:19|20)\d\d$"></asp:RegularExpressionValidator>
        ...
        <tr>
            <td style="width: 300px">
                <asp:Label ID="Label40" runat="server" Text="Other Information"></asp:Label>
            </td>
            <td>
