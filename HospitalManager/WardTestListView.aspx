<%@ Page Title="" Language="C#" MasterPageFile="~/HospitalMaster2.master" AutoEventWireup="true" CodeBehind="WardTestListView.aspx.cs" Inherits="HospitalManager.WardTestListView" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:UpdatePanel runat="server">
        ...
        <span id="AscDescSpan" runat="server" visible="false">=>&nbsp;&nbsp;&nbsp;&nbsp;<asp:RadioButton ID="AscRadioButton" GroupName="SecondSort" AutoPostBack="true" Text="Ascending" runat="server" />
            ...
            <br />
            <asp:ListView ID="ListView1" runat="server" OnSelectedIndexChanged="ListView1_SelectedIndexChanged" OnSelectedIndexChanging="ListView1_SelectedIndexChanging" OnPagePropertiesChanged="ListView1_PagePropertiesChanged">
                <LayoutTemplate>
